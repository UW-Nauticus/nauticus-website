      ...
      <MKBox component="nav" position="absolute" top="0.5rem" width="100%">
        <Container>
          <Grid container flexDirection="row" alignItems="center">
            ...
            >
              <MKBox component="li">
                <MKTypography component={Link} href="/about" variant="button" color="white" fontWeight="regular" p={1}>
                  About
                </MKTypography>
              </MKBox>
              <MKBox component="li">
                <MKTypography component={Link} href="/join" variant="button" color="white" fontWeight="regular" p={1}>
                  Sign Up
                </MKTypography>
              </MKBox>
              <MKBox component="li">
              ...
              <MKBox component="li">
                <MKTypography component={Link} href="/faq" variant="button" color="white" fontWeight="regular" p={1}>
                  FAQ
                </MKTypography>
              </MKBox>
              <MKBox component="li">
            ...
            <MKBox component="ul" display={{ xs: 'none', lg: 'flex' }} p={0} m={0} sx={{ listStyle: 'none' }}>
              <MKBox component="li">
                ...
                >
                  <MKBox component="i" color="white" className="fab fa-github" />
                </MKTypography>
              </MKBox>
              <MKBox component="li">
