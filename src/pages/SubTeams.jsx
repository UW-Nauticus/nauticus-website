          ...
          <Grid item xs={12}>
            ...
            <Grid container alignItems="center" spacing={6}>
              ...
              <Grid item xs={12} md={6}>
                ...
                <br />
                <MKTypography variant="body2" color="text">
                  Would you ilke to be a hard working hardware engineer. Look at moustaf on the left. We found him when
                  he was only a child and were like father to him. Now he's putting in the last touches to the hydrogen
                  bomb, i mean rov, that we are developing to take over the world, i mean win the competition
                </MKTypography>
              </Grid>
