...
import { faFacebook, faGithub, faInstagram, faYoutube, faLinkedin } from '@fortawesome/free-brands-svg-icons';
...
library.add(faGithub, faInstagram, faYoutube, faFacebook, faLinkedin);
